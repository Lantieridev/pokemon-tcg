...
public enum AttackEffectType {
    ...
    DRAW_CARDS,
    DAMAGE_TIMES_SELF_COUNTERS,
    DAMAGE_PER_RETREAT_COST,
    PLACE_COUNTERS_OPPONENT,
    PLACE_COUNTERS_DISTRIBUTED,
    MOVE_OPPONENT_COUNTERS,
    DISCARD_OPPONENT_HAND_TO_LIMIT,
    PLACE_OPPONENT_BASIC_FROM_DISCARD,
    DISCARD_TRAINER_FROM_OPPONENT_HAND,
    SHUFFLE_POKEMON_FROM_DISCARD
}
