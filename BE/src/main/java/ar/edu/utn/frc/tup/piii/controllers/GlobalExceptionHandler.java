...
public final class GlobalExceptionHandler {
    ...
    public ResponseEntity<String> handleOptimisticLockConflict(final ObjectOptimisticLockingFailureException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body("Otra operación modificó tu cuenta al mismo tiempo. Volvé a intentarlo.");
    }
}
